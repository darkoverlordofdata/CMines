@STATIC;1.0;p;15;AppController.jt;16022;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.ji;12;SquareView.jt;15937;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);objj_executeFile("SquareView.j", YES);var DIMENSION = 40;
var SEPARATOR = 10;
var MARGIN = 6;

{var the_class = objj_allocateClassPair(CPObject, "AppController"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("window", "CPWindow"), new objj_ivar("timeField", "CPTextField"), new objj_ivar("markField", "CPTextField"), new objj_ivar("fields", "SquareView"), new objj_ivar("uncovered", "int"), new objj_ivar("atStart", "BOOL"), new objj_ivar("startDate", "CPDate")]);objj_registerClassPair(the_class);
...
,["void","CPNotification"]), new objj_method(sel_getUid("makeGameWindow"), function $AppController__makeGameWindow(self, _cmd)
{
    ...
    for (var row = 0; row < 8; row++)
    {
        for (var col = 0; col < 8; col++)
        {
            ...
            var field = ((___r1 = (SquareView.isa.method_msgSend["alloc"] || _objj_forward)(SquareView, "alloc")), ___r1 == null ? ___r1 : (___r1.isa.method_msgSend["initAtPoint:row:col:controller:"] || _objj_forward)(___r1, "initAtPoint:row:col:controller:", spoint, row, col, self));
    ...
    ((___r1 = self.markField), ___r1 == null ? ___r1 : (___r1.isa.method_msgSend["setDrawsBackground:"] || _objj_forward)(___r1, "setDrawsBackground:", YES));
...
,["id","SquareView"]), new objj_method(sel_getUid("uncoverAll:"), function $AppController__uncoverAll_(self, _cmd, item)
{
    for (var row = 0; row < 8; row++)
    {
        for (var col = 0; col < 8; col++)
...
,["id","SquareView"]), new objj_method(sel_getUid("uncovered:"), function $AppController__uncovered_(self, _cmd, item)
{
...
,["id","SquareView"]), new objj_method(sel_getUid("marked:"), function $AppController__marked_(self, _cmd, item)
{
...
,["id","SquareView"]), new objj_method(sel_getUid("start"), function $AppController__start(self, _cmd)
{
    if (self.atStart == YES)
    {
...
p;12;SquareView.jt;17481;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.jt;17413;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/AppKit.j", NO);var DIMENSION = 40;
var SEPARATOR = 10;
var MARGIN = 6;
...
{var the_class = objj_allocateClassPair(CPView, "SquareView"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("row", "int"), new objj_ivar("col", "int"), new objj_ivar("isMine", "BOOL"), new objj_ivar("neighbors", "int"), new objj_ivar("covered", "COV_STATE"), new objj_ivar("marked", "BOOL"), new objj_ivar("con", "id"), new objj_ivar("path", "CPBezierPath"), new objj_ivar("image_0", "CPImage"), new objj_ivar("image_1", "CPImage"), new objj_ivar("image_2", "CPImage"), new objj_ivar("image_3", "CPImage"), new objj_ivar("image_4", "CPImage"), new objj_ivar("image_5", "CPImage"), new objj_ivar("image_6", "CPImage"), new objj_ivar("image_7", "CPImage"), new objj_ivar("image_8", "CPImage"), new objj_ivar("image_flag", "CPImage"), new objj_ivar("image_hidden", "CPImage"), new objj_ivar("image_mine", "CPImage"), new objj_ivar("image_misplaced", "CPImage"), new objj_ivar("image_question", "CPImage")]);objj_registerClassPair(the_class);
class_addMethods(the_class, [new objj_method(sel_getUid("initAtPoint:row:col:controller:"), function $SquareView__initAtPoint_row_col_controller_(self, _cmd, aPoint, rval, cval, theCon)
{
    self.image_0 = ((___r1 = (CPImage.isa.method_msgSend["alloc"] || _objj_forward)(CPImage, "alloc")), ___r1 == null ? ___r1 : (___r1.isa.method_msgSend["initWithContentsOfFile:size:"] || _objj_forward)(___r1, "initWithContentsOfFile:size:", "Resources/0.png", CPSizeMake(40, 40)));
    self.image_1 = ((___r1 = (CPImage.isa.method_msgSend["alloc"] || _objj_forward)(CPImage, "alloc")), ___r1 == null ? ___r1 : (___r1.isa.method_msgSend["initWithContentsOfFile:size:"] || _objj_forward)(___r1, "initWithContentsOfFile:size:", "Resources/1.png", CPSizeMake(40, 40)));
    self.image_2 = ((___r1 = (CPImage.isa.method_msgSend["alloc"] || _objj_forward)(CPImage, "alloc")), ___r1 == null ? ___r1 : (___r1.isa.method_msgSend["initWithContentsOfFile:size:"] || _objj_forward)(___r1, "initWithContentsOfFile:size:", "Resources/2.png", CPSizeMake(40, 40)));
    self.image_3 = ((___r1 = (CPImage.isa.method_msgSend["alloc"] || _objj_forward)(CPImage, "alloc")), ___r1 == null ? ___r1 : (___r1.isa.method_msgSend["initWithContentsOfFile:size:"] || _objj_forward)(___r1, "initWithContentsOfFile:size:", "Resources/3.png", CPSizeMake(40, 40)));
    self.image_4 = ((___r1 = (CPImage.isa.method_msgSend["alloc"] || _objj_forward)(CPImage, "alloc")), ___r1 == null ? ___r1 : (___r1.isa.method_msgSend["initWithContentsOfFile:size:"] || _objj_forward)(___r1, "initWithContentsOfFile:size:", "Resources/4.png", CPSizeMake(40, 40)));
    self.image_5 = ((___r1 = (CPImage.isa.method_msgSend["alloc"] || _objj_forward)(CPImage, "alloc")), ___r1 == null ? ___r1 : (___r1.isa.method_msgSend["initWithContentsOfFile:size:"] || _objj_forward)(___r1, "initWithContentsOfFile:size:", "Resources/5.png", CPSizeMake(40, 40)));
    self.image_6 = ((___r1 = (CPImage.isa.method_msgSend["alloc"] || _objj_forward)(CPImage, "alloc")), ___r1 == null ? ___r1 : (___r1.isa.method_msgSend["initWithContentsOfFile:size:"] || _objj_forward)(___r1, "initWithContentsOfFile:size:", "Resources/6.png", CPSizeMake(40, 40)));
    self.image_7 = ((___r1 = (CPImage.isa.method_msgSend["alloc"] || _objj_forward)(CPImage, "alloc")), ___r1 == null ? ___r1 : (___r1.isa.method_msgSend["initWithContentsOfFile:size:"] || _objj_forward)(___r1, "initWithContentsOfFile:size:", "Resources/7.png", CPSizeMake(40, 40)));
    self.image_8 = ((___r1 = (CPImage.isa.method_msgSend["alloc"] || _objj_forward)(CPImage, "alloc")), ___r1 == null ? ___r1 : (___r1.isa.method_msgSend["initWithContentsOfFile:size:"] || _objj_forward)(___r1, "initWithContentsOfFile:size:", "Resources/8.png", CPSizeMake(40, 40)));
    self.image_flag = ((___r1 = (CPImage.isa.method_msgSend["alloc"] || _objj_forward)(CPImage, "alloc")), ___r1 == null ? ___r1 : (___r1.isa.method_msgSend["initWithContentsOfFile:size:"] || _objj_forward)(___r1, "initWithContentsOfFile:size:", "Resources/flag.png", CPSizeMake(40, 40)));
    self.image_hidden = ((___r1 = (CPImage.isa.method_msgSend["alloc"] || _objj_forward)(CPImage, "alloc")), ___r1 == null ? ___r1 : (___r1.isa.method_msgSend["initWithContentsOfFile:size:"] || _objj_forward)(___r1, "initWithContentsOfFile:size:", "Resources/hidden.png", CPSizeMake(40, 40)));
    self.image_mine = ((___r1 = (CPImage.isa.method_msgSend["alloc"] || _objj_forward)(CPImage, "alloc")), ___r1 == null ? ___r1 : (___r1.isa.method_msgSend["initWithContentsOfFile:size:"] || _objj_forward)(___r1, "initWithContentsOfFile:size:", "Resources/mine.png", CPSizeMake(40, 40)));
    self.image_misplaced = ((___r1 = (CPImage.isa.method_msgSend["alloc"] || _objj_forward)(CPImage, "alloc")), ___r1 == null ? ___r1 : (___r1.isa.method_msgSend["initWithContentsOfFile:size:"] || _objj_forward)(___r1, "initWithContentsOfFile:size:", "Resources/misplaced.png", CPSizeMake(40, 40)));
    self.image_question = ((___r1 = (CPImage.isa.method_msgSend["alloc"] || _objj_forward)(CPImage, "alloc")), ___r1 == null ? ___r1 : (___r1.isa.method_msgSend["initWithContentsOfFile:size:"] || _objj_forward)(___r1, "initWithContentsOfFile:size:", "Resources/question.png", CPSizeMake(40, 40)));
    var frame = CPMakeRect(0, 0, 0, 0);
    frame.origin = aPoint;
    frame.size.width = frame.size.height = DIMENSION;
    (objj_getClass("SquareView").super_class.method_dtable["initWithFrame:"] || _objj_forward)(self, "initWithFrame:", frame);
...
,["id","CPPoint","int","int","id"]), new objj_method(sel_getUid("row"), function $SquareView__row(self, _cmd)
{
    return self.row;
}

,["int"]), new objj_method(sel_getUid("col"), function $SquareView__col(self, _cmd)
{
    return self.col;
}

,["int"]), new objj_method(sel_getUid("setDefaults"), function $SquareView__setDefaults(self, _cmd)
{
    self.isMine = NO;
    self.neighbors = 0;
...
,["id"]), new objj_method(sel_getUid("setMine:"), function $SquareView__setMine_(self, _cmd, flag)
{
    if (flag != self.isMine)
    {
        (self.isa.method_msgSend["setNeedsDisplay:"] || _objj_forward)(self, "setNeedsDisplay:", YES);
...
,["id","BOOL"]), new objj_method(sel_getUid("setNeighbors:"), function $SquareView__setNeighbors_(self, _cmd, count)
{
...
,["id","int"]), new objj_method(sel_getUid("setCovered:"), function $SquareView__setCovered_(self, _cmd, aState)
{
...
,["id","COV_STATE"]), new objj_method(sel_getUid("setMarked:"), function $SquareView__setMarked_(self, _cmd, flag)
{
    if (flag != self.marked)
    {
        (self.isa.method_msgSend["setNeedsDisplay:"] || _objj_forward)(self, "setNeedsDisplay:", YES);
...
,["id","BOOL"]), new objj_method(sel_getUid("mine"), function $SquareView__mine(self, _cmd)
{
    return self.isMine;
}

,["BOOL"]), new objj_method(sel_getUid("neighbors"), function $SquareView__neighbors(self, _cmd)
{
    return self.neighbors;
}

,["int"]), new objj_method(sel_getUid("covered"), function $SquareView__covered(self, _cmd)
{
    return self.covered;
}

,["COV_STATE"]), new objj_method(sel_getUid("marked"), function $SquareView__marked(self, _cmd)
{
    return self.marked;
}

,["BOOL"]), new objj_method(sel_getUid("drawRect:"), function $SquareView__drawRect_(self, _cmd, aRect)
{
...
,["void","CPRect"]), new objj_method(sel_getUid("mouseDown:"), function $SquareView__mouseDown_(self, _cmd, theEvent)
{
...
,["void","CPEvent"]), new objj_method(sel_getUid("rightMouseDown:"), function $SquareView__rightMouseDown_(self, _cmd, theEvent)
{
    if (self.covered == COV_COVERED)
    {
